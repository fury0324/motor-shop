...
function AuthShell({ children }) {
  return (
    <div className="min-h-screen bg-white font-['Inter'] flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative bg-brand-navy overflow-hidden flex-col p-12 xl:p-16">
        ...
        <div className="relative z-10 flex-1 flex flex-col justify-center space-y-6">
          ...
          <h1 className="text-4xl font-black text-white leading-tight tracking-tight">
            Precision Operations<br />for <span className="italic text-brand-red">Zamboanga City.</span>
          </h1>
