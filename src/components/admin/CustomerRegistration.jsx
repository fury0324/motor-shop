    ...
    <div className="p-4 sm:p-5">
        ...
        <div className="flex justify-end">
          <div className="hidden md:flex gap-3">
            <button 
              ...
              className="px-4 py-2 border border-[#c6c6cd] text-[#0b1c30] text-xs font-semibold rounded-lg hover:bg-[#eff4ff] transition-colors"
            >
              Cancel
            </button>
            <button 
              ...
              className="px-4 py-2 bg-black text-white text-xs font-semibold rounded-lg shadow-sm hover:opacity-90 transition-opacity active:scale-95 disabled:opacity-50"
            >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white p-3 border-t border-[#c6c6cd] flex gap-3 z-50 shadow-lg">
        <button 
          ...
          className="flex-1 py-2.5 border border-[#c6c6cd] text-[#0b1c30] text-sm font-semibold rounded-lg"
        >
          Cancel
        </button>
        {currentStep < 3 ? (
