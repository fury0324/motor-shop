...
function Transaction({ onNavigateToAddCustomer, onNavigateToTransactionList }) {
  ...
  // Steps for Part transaction - SUPER SIMPLE
  const partSteps = [
  ...
  const filteredCustomers = customers.filter(customer =>
    ...
    customer.contactNumber?.includes(searchCustomerTerm)
  )
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        text: `Transaction ${result.transactionNo} has been successfully processed.`,
        timer: 3000,
  ...
  // If no transaction type selected yet, show the selection screen
  if (!transactionType) {
    return (
    ...
    <div className="p-4 sm:p-5">
      ...
      <div className="mb-6">
        <nav className="flex items-center gap-2 text-sm text-[#45464d] mb-2">
          <span>Transactions</span>
          <span className="material-symbols-outlined text-sm">chevron_right</span>
          <span className="text-black font-semibold">New {isPart ? 'Parts' : 'Motorcycle'} Transaction</span>
        </nav>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="lg:col-span-2">
          {/* Step 1: Customer - Different for Model vs Part */}
          {currentStep === 1 && (
            <div className="bg-white border border-[#c6c6cd] rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-4">
                {isPart ? (
                  ...
                  // MODELS: Full customer selection with search
                  <>
                    <div>
                      ...
                      <div className="bg-[#f8f9ff] p-4 rounded-lg border border-[#c6c6cd] mt-4">
                        ...
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-[#45464d] mt-1">{selectedCustomer.homeAddress}</p>
                          </div>
                        </div>
                      </div>
                    )}
          ...
          {/* Step 2: Product Selection - Different for Model vs Part */}
          {currentStep === 2 && (
            <div className="bg-white border border-[#c6c6cd] rounded-xl p-5 shadow-sm">
              <div className="flex items-center gap-2 mb-4">
          ...
          {/* Step 3: Payment - Different for Model vs Part */}
            ...
            <div className="bg-white border border-[#c6c6cd] rounded-xl p-5 shadow-sm">
              ...
              <div className="space-y-4">
                {isPart ? (
                  ...
                  // MODELS: Full payment with cash/installment
                  <>
          ...
          {/* Step: Confirm */}
          {currentStep === steps.length && selectedCustomer && selectedProduct && (
