...
// payment, generates PRT-YYYYMM-00001 via an atomic counter, and decrements
// inventory quantity/stock in the same Firestore transaction.
router.post('/createPartsTransaction', callable(async (request) => {
...
async function deletePartsTransactionInternal(db, transactionId) {
...
router.post('/deletePartsTransaction', callable(async (request) => {
  assertStaffOrAbove(request.auth)
...
router.post('/bulkDeletePartsTransactions', callable(async (request) => {
  assertStaffOrAbove(request.auth)
